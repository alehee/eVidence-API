    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupDepartments", x => new { x.DepartmentsId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_GroupDepartments_Departments_DepartmentsId",
                        column: x => x.DepartmentsId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupDepartments_Groups_GroupsId",
                        column: x => x.GroupsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupDepartments_GroupsId",
